export function Contact() {
  return (
    <section className="section contact" id="contato">
      ...
      <p>
        Todos os sistemas que construí estão em produção, com usuários reais. Se você quer ver uma demo ao vivo ou
        conversar sobre um projeto, é só mandar uma mensagem.
      </p>
      ...
      <div className="contact-btns">
        ...
        <a href="https://wa.me/5511973988169" target="_blank" rel="noopener noreferrer" className="btn-secondary">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
